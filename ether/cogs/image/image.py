...
class ImageModifier:
    ...
    def write(self, text: str, xy: tuple[int, int], max_words:int=30, max_lines:int=-1, anchor="la", fill=(0, 0, 0)):
        ...
        for match in sentences:
            ...
            for subs in splitted:
                ...
                draw.text((xy[0], xy[1] + height*i), subs.strip(), fill=fill, font=ImageModifier.FONT, anchor=anchor)
                i+=1
