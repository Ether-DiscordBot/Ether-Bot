...
class CardHandler:
    ...
    async def create_card(self, user, db_user):
        ...
        # Discriminator
        draw.text(
            xy=(self.pseudo_left_padding + self.font.getsize(f"{user.name[:13]}")[0] + 5,
        ...
        # User exp
        draw.text(
            xy=(self.pseudo_left_padding,
                self.img_size[1] - self.pseudo_top_padding - self.line_width / 2 + self.line_width + 3),
            text=f"{db_user['exp']}",
            fill=(255, 255, 255),
            font=self.exp_font)
        ...
        # Max exp
        draw.text(
            xy=(self.pseudo_left_padding + self.exp_font.getsize(f"{db_user['exp']}")[0],
                img.size[1] - self.pseudo_top_padding - self.line_width / 2 + self.line_width + 3),
